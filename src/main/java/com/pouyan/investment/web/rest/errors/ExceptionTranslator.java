package com.pouyan.investment.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.pouyan.investment.service.EmailAlreadyUsedException ||
            ex instanceof com.pouyan.investment.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.pouyan.investment.service.InvalidPasswordException
